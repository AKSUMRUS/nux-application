package com.ledokol.dvor.data.local.user

sealed class UserEvent {
    class Refresh(val shouldReload: Boolean = true) :
        UserEvent() // Обновить данные по всем пользователям

    class OnSearchQueryChange(val query: String) :
        UserEvent() // Поиск пользователей по совпадению имени

    class OnSearchQueryChangeFindFriend(val query: String) :
        UserEvent() // Поиск новых друзей по совпадению имени
    ...
    object ClearInviteFriend : UserEvent()
